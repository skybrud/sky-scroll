(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("sky-scroll", [], factory);
	else if(typeof exports === 'object')
		exports["sky-scroll"] = factory();
	else
		root["SkyScroll"] = factory();
...
var SkyScrollPlugin = {
	install: function install(Vue, options) {
		...
		var config = (0, _assign2.default)({}, _defaults, options);
		...
		var _vm = new Vue({
			...
			methods: {
				...
				_recalculateHandler: function _recalculateHandler() {
		...
		(0, _defineProperties2.default)($SkyScroll, {
			scroll: {
				enumerable: true,
				get: function get() {
		...
		if (typeof window !== 'undefined') {
			window.addEventListener('scroll', function () {
				return $SkyScroll.emit('recalculate', 'scroll');
			});
			window.addEventListener('resize', (0, _lodash2.default)(function () {
				return $SkyScroll.emit('recalculate', 'resize');
			}, config.throttle));
...
$export($export.S + $export.F * !__webpack_require__(0), 'Object', { defineProperties: __webpack_require__(25) });
